...
class Faq extends Migration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('category', 'string', array('length' => 255,'null' => false, 'default' => '', 'comment' => '类型'));
        $table->addColumn('question', 'string', array('length' => 255,'null' => false, 'default' => '', 'comment' => '问题'));
        $table->addColumn('answer', 'string', array('length' => 255,'null' => false, 'default' => '', 'comment' => '快捷回复模板'));
